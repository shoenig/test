...
cp assert.go must/invocation.go
cp assert_test.go must/invocation_test.go
...
sed -i "s|package test|package must|g" must/invocation.go
sed -i "s|package test|package must|g" must/invocation_test.go
